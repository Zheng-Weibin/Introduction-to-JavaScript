...
if (votingAge >= 18) {
  ...
  console.log("task 1a: ", "You can not vote yet");
}
...
console.log("task 1d: ", multiply(4, 7));
...
console.log("stretch: ", vowelCounter("hello"));
